...
public class QuitButton extends ButtonHandler implements ButtonAction {
    public QuitButton(final Game game, final int x, final int y) {
    ...
    public void render(Graphics2D graphics) {
        ...
        this.renderText(graphics, "QUITTER");
    }
